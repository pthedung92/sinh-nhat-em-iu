  ...
  return (
    <div className="flex min-h-dvh flex-1 flex-col items-center justify-center bg-zinc-100 px-6 py-16">
      <main className="w-full max-w-md rounded-2xl border border-zinc-200/80 bg-white p-10 text-center shadow-sm">
        ...
        <Link
          href="/bao-tran-birthday-2026"
          className="mt-8 inline-flex w-full items-center justify-center rounded-xl bg-violet-500 px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-violet-600"
        >
