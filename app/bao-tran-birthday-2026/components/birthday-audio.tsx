      ...
      >
        <defs>
          ...
          <linearGradient id="frost-drip" x1="0" y1="0" x2="0" y2="1">
            ...
            <stop offset="100%" stopColor="#f5f3ff" stopOpacity="0.85" />
          </linearGradient>
        </defs>
        ...
        <path
          ...
          strokeLinecap="round"
        />
        <ellipse cx="120" cy="44" rx="14" ry="8" fill="#c084fc" opacity="0.9" />
  ...
  return (
    ...
    >
      <p
        ...
        className="font-[family-name:var(--font-nunito)] text-center text-2xl font-extrabold text-violet-100 sm:text-3xl"
      >
        Thổi nến nhé 🎂
      </p>
      <p className="mt-2 max-w-md text-center font-[family-name:var(--font-be-vietnam-pro)] text-sm text-violet-200/90">
        em iu thổi vừa phải thui nheee
      </p>
      ...
      <div className="mt-10 w-full max-w-xs">
        {!micListening ? (
          <button
            type="button"
            onClick={startMic}
            className="w-full rounded-2xl border-2 border-violet-400 bg-violet-500 px-6 py-3.5 font-[family-name:var(--font-be-vietnam-pro)] text-base font-semibold text-white shadow-lg transition hover:bg-violet-600"
          >
