...
import { CalendarJuly, PhotoFrame } from "../photo-elements";
    ...
    >
      ...
      <div className="relative z-[1] w-full pt-11 sm:pt-12">
        ...
        <div className="mx-auto mt-6 flex w-full max-w-md flex-col items-center gap-4 sm:mt-8 sm:max-w-lg">
          ...
          <PhotoFrame
            src='/images/bao-tran-birthday/2026/bao-tran-8.jpg'
      ...
      <div className="relative mt-8 w-full border-t-2 border-dashed border-violet-200/70 pt-6 sm:mt-10 sm:pt-8">
