...
export function hl(text: string, color = "bg-violet-200") {
  return (
...
const HEART_BG_SPOTS: { pos: string; delay: number; size: string; tone: string }[] = [
  { pos: "left-[2%] top-[8%]", delay: 0, size: "h-9 w-9 sm:h-10 sm:w-10", tone: "text-violet-400/55" },
  { pos: "left-[8%] top-[22%]", delay: 0.35, size: "h-7 w-7 sm:h-8 sm:w-8", tone: "text-violet-500/45" },
  { pos: "left-[4%] top-[42%]", delay: 0.7, size: "h-11 w-11 sm:h-12 sm:w-12", tone: "text-violet-400/50" },
  { pos: "left-[1%] top-[62%]", delay: 1.1, size: "h-8 w-8", tone: "text-violet-400/40" },
  { pos: "left-[12%] bottom-[18%]", delay: 0.2, size: "h-10 w-10 sm:h-11 sm:w-11", tone: "text-violet-500/48" },
  { pos: "left-[6%] bottom-[6%]", delay: 1.4, size: "h-6 w-6 sm:h-7 sm:w-7", tone: "text-violet-500/42" },
  { pos: "right-[3%] top-[10%]", delay: 0.5, size: "h-10 w-10", tone: "text-violet-400/52" },
  { pos: "right-[7%] top-[28%]", delay: 0.9, size: "h-8 w-8 sm:h-9 sm:w-9", tone: "text-violet-400/46" },
  { pos: "right-[2%] top-[48%]", delay: 0.15, size: "h-12 w-12 sm:h-14 sm:w-14", tone: "text-violet-500/44" },
  { pos: "right-[9%] top-[58%]", delay: 1.2, size: "h-7 w-7", tone: "text-violet-400/38" },
  { pos: "right-[4%] bottom-[22%]", delay: 0.6, size: "h-11 w-11", tone: "text-violet-500/50" },
  { pos: "right-[1%] bottom-[8%]", delay: 1.5, size: "h-9 w-9", tone: "text-violet-500/42" },
  { pos: "left-[18%] top-[14%]", delay: 0.4, size: "h-6 w-6 sm:h-7 sm:w-7", tone: "text-violet-400/35" },
  { pos: "right-[16%] top-[12%]", delay: 0.8, size: "h-7 w-7", tone: "text-violet-400/40" },
  { pos: "left-[22%] top-[55%]", delay: 1.0, size: "h-8 w-8", tone: "text-violet-500/36" },
  { pos: "right-[20%] bottom-[12%]", delay: 0.25, size: "h-9 w-9", tone: "text-violet-400/48" },
  { pos: "left-[32%] top-[6%]", delay: 1.3, size: "h-5 w-5 sm:h-6 sm:w-6", tone: "text-violet-500/32" },
  { pos: "right-[30%] top-[8%]", delay: 0.55, size: "h-6 w-6", tone: "text-violet-500/34" },
  { pos: "left-[40%] top-[3%]", delay: 0.1, size: "h-7 w-7", tone: "text-violet-400/30" },
  { pos: "right-[38%] top-[4%]", delay: 1.6, size: "h-5 w-5", tone: "text-violet-400/34" },
  { pos: "left-[48%] top-[12%]", delay: 0.45, size: "h-8 w-8", tone: "text-violet-500/38" },
  { pos: "right-[46%] bottom-[8%]", delay: 1.15, size: "h-10 w-10", tone: "text-violet-500/40" },
  { pos: "left-[52%] bottom-[4%]", delay: 0.65, size: "h-6 w-6", tone: "text-violet-400/36" },
  { pos: "left-[28%] bottom-[10%]", delay: 1.35, size: "h-7 w-7", tone: "text-violet-500/40" },
  { pos: "right-[42%] top-[38%]", delay: 0.3, size: "h-5 w-5", tone: "text-violet-400/28" },
  { pos: "left-[14%] top-[78%]", delay: 1.25, size: "h-8 w-8", tone: "text-violet-400/44" },
  { pos: "right-[12%] top-[72%]", delay: 0.75, size: "h-7 w-7", tone: "text-violet-500/38" },
];
