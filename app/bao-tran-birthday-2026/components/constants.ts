...
/** Lower = easier. Peak catches short puffs better than RMS alone. */
export const BLOW_RMS_THRESHOLD = 0.001;
export const BLOW_PEAK_THRESHOLD = 0.012;
/** 1 = instant on first puff. */
export const BLOW_FRAMES_REQUIRED = 1;
export const MIC_WARMUP_MS = 0;
