  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative w-full max-w-md rounded-[1.75rem] border-2 border-violet-300/50 bg-gradient-to-b from-white/95 via-[#faf5ff] to-[#f5f3ff] p-8 text-center shadow-[0_24px_60px_rgba(109,40,217,0.25),0_0_0_1px_rgba(255,255,255,0.8)_inset]"
      >
        <div
          className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl border-2 border-dashed border-violet-300/70 bg-violet-50/80 text-4xl shadow-sm"
          aria-hidden
        >
          💻
        </div>
        <p className="font-[family-name:var(--font-be-vietnam-pro)] text-xs font-semibold uppercase tracking-[0.25em] text-violet-500">
          Bảo Trân · 13.07
        </p>
        <h2
          id="desktop-only-title"
          className="mt-3 font-[family-name:var(--font-nunito)] text-2xl font-extrabold leading-tight text-violet-950 sm:text-[1.65rem]"
        >
          Mở trên máy tính
        ...
        >
          ...
          <span className="font-semibold text-violet-700">màn hình lớn</span> - em iu 
