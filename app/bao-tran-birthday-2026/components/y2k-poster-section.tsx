...
export function Y2KScrapbookPoster() {
  return (
    ...
    >
      ...
      />
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-white/80 via-violet-50/20 to-yellow-50/25" />

      <div className="relative z-20 flex flex-wrap items-center justify-between gap-2 border-b-2 border-violet-200/90 bg-white/96 px-3 py-2.5 backdrop-blur-sm sm:px-4">
      ...
      <div className="relative z-10 min-h-[420px] pb-24 pt-2 font-[family-name:var(--font-poster-display),sans-serif] sm:min-h-[480px] sm:pb-28">
        ...
        <div className="absolute right-2 top-16 z-30 max-w-[130px] rounded-2xl border-2 border-violet-400 bg-white px-2.5 py-1.5 text-center text-[10px] font-sans font-bold leading-tight text-violet-600 shadow-md sm:right-6 sm:top-18 sm:max-w-[200px] sm:px-3 sm:py-2 sm:text-xs">
        ...
        <div className="absolute left-[21%] top-[0.5rem] z-20 ">
          <img src="/images/bao-tran-birthday/2026/bao-tran-1.png" alt="handsome" className="h-120 w-120 object-cover" loading="lazy" />
        </div>

        <div className="absolute right-2 top-[10rem] z-30 flex flex-col items-end gap-3 sm:right-5 sm:top-[13rem]">
          <ViewfinderPhoto
            src="/images/bao-tran-birthday/2026/bao-tran-3.jpg"
        ...
        <div className="absolute left-3 top-[13rem] z-[25] sm:left-6 ">
          ...
          >
            ...
            <img
              src="/images/bao-tran-birthday/2026/bao-tran-2.jpeg"
